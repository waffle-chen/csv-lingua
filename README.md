...
| One 512-token chunk through BERT | **0.93 s** (2.47 s in the first version) |
| Whole run: 7 kB meeting → 856 of 1,534 words | **7.4 s**, 822 MB RAM |
| Tokenizer | 3.6 M characters/s |
| CSV parser | 27 MB/s on one thread, 87 MB/s on all cores |
